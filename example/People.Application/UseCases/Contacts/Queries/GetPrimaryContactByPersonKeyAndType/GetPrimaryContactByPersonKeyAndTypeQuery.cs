namespace People.Application.UseCases.Contacts.Queries.GetPrimaryContactByPersonKeyAndType;

using Core.Libraries.Application.Queries;

/// <summary>
/// Query to get the primary contact of a specific type for a person.
/// </summary>
public class GetPrimaryContactByPersonKeyAndTypeQuery : IQuery<GetPrimaryContactByPersonKeyAndTypeQueryResponse?>
{
    /// <summary>
...
/// <summary>
/// Response for the GetPrimaryContactByPersonKeyAndTypeQuery.
/// </summary>
public class GetPrimaryContactByPersonKeyAndTypeQueryResponse
{
    /// <summary>

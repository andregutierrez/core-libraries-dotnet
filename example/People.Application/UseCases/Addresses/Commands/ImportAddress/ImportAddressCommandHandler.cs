...
/// </summary>
public class ImportAddressCommandHandler : ICommandHandler<ImportAddressCommand, ImportAddressCommandResponse>
{
    ...
    /// <summary>
    /// Initializes a new instance of <see cref="ImportAddressCommandHandler"/>.
    /// </summary>
    ...
    public ImportAddressCommandHandler(
    ...
    /// <summary>
    /// Handles the ImportAddressCommand.
    /// </summary>
    /// <param name="request">The command request.</param>
    /// <param name="cancellationToken">The cancellation token.</param>
    /// <returns>The response containing the imported address's alternate key.</returns>
    /// <exception cref="ArgumentException">Thrown when the address type is invalid.</exception>
    public async Task<ImportAddressCommandResponse> Handle(
        ImportAddressCommand request,
        CancellationToken cancellationToken)
    {
        ...
        // Import the address using the domain factory method
        var address = Address.Import(
        ...
        return new ImportAddressCommandResponse
        {

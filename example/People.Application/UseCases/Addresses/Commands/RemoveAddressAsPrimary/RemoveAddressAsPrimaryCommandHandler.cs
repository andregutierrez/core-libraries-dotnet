...
/// <summary>
/// Handler for the RemoveAddressAsPrimaryCommand.
/// </summary>
public class RemoveAddressAsPrimaryCommandHandler : ICommandHandler<RemoveAddressAsPrimaryCommand>
{
    private readonly IAddressRepository _addressRepository;
    private readonly IUnitOfWork _unitOfWork;

    /// <summary>
    /// Initializes a new instance of <see cref="RemoveAddressAsPrimaryCommandHandler"/>.
    /// </summary>
    /// <param name="addressRepository">The address repository.</param>
    /// <param name="unitOfWork">The unit of work.</param>
    public RemoveAddressAsPrimaryCommandHandler(
    ...
    /// <summary>
    /// Handles the RemoveAddressAsPrimaryCommand.
    /// </summary>
    /// <param name="request">The command request.</param>
    /// <param name="cancellationToken">The cancellation token.</param>
    /// <returns>A task representing the asynchronous operation.</returns>
    public async Task Handle(
        RemoveAddressAsPrimaryCommand request,
        CancellationToken cancellationToken)
    {
        ...
        // Remove primary flag using the domain method

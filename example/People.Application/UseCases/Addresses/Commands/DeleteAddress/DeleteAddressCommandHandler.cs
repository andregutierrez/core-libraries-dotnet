namespace People.Application.UseCases.Addresses.Commands.DeleteAddress;
...
/// <summary>
/// Handler for the DeleteAddressCommand.
/// </summary>
public class DeleteAddressCommandHandler : ICommandHandler<DeleteAddressCommand>
{
    ...
    /// <summary>
    /// Initializes a new instance of <see cref="DeleteAddressCommandHandler"/>.
    /// </summary>
    ...
    /// <summary>
    /// Handles the DeleteAddressCommand.
    /// </summary>
